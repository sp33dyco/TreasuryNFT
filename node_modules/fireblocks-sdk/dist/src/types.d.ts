...
declare type TravelRulePersonAddress = {
...
export declare type TokenWithBalance = (WorkspaceWalletIdentifier | NonCustodialWalletIdentifier) & BaseTokenWithBalance;
...
export declare type CreateWeb3ConnectionPayload = (WorkspaceWalletIdentifier | NonCustodialWalletIdentifier) & BaseWeb3ConnectionPayload;
export declare type CreateWalletConnectPayload = CreateWeb3ConnectionPayload & WalletConnectConnectionPayload;
...
declare type CreateTokenParams = EVMTokenCreateParamsDto | StellarRippleCreateParamsDto;
